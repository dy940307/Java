...
/*
	...
	소수 판별 알고리즘 : https://st-lab.tistory.com/81
	 1. n이 소수인지 판별하기 위해 2부터 n보다 작은 자연수들로 나눠본다.
	 2. n이 소수인지 판별하기 위해 2부터 n의 제곱근 이하의 자연수들로 나눠본다.
	 3. 에라토스테네스의 체
...
public class PrimeNumber {
	public static void main(String[] args) {
		...
		long elapsedTime1, elapsedTime2, elapsedTime3; // 1번 ~ 3번 알고리즘 실행 시간 저장 변수
		...
		for(int i = 2; i <= 1000; i++) {
			...
			if(!found1)
				System.out.println("첫 번째 알고리즘 소수: " + i);
		}
		...
		for(int i = 2; i <= 1000; i++) {
			...
			if(!found2)
				System.out.println("두 번째 알고리즘 소수: " + i);
		}
